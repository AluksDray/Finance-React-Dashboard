...
export default function InvestmentDetails({titleText, amountText, incomeData, currencyDrop,currencyDropChange, selectedCurrency}){
            ...
            <div className="container2">
                <div className="container2-child1">
                    ...
                    <div className="number-cont">
                        <div className="amount-cont2">
                            <h2>{amountText}</h2>
                        </div>
                        <div className="currency-cont">
                            <select
                            value={selectedCurrency}
                            onChange={currencyDropChange}
                            >
                                {currencyDrop.map((currency, index)=>(
                ...
                <div className="container2-child2">
                    {incomeData && incomeData.map((item, index) => (
                        <div className="price-cont" key={index}>
                            <div className="money-month-cont2">
                                <h3>{item.Amount}</h3>
                                <p>{item.Month}</p>
                            </div>
